...
public class Run {
	public static void main(String[] args) {
		 ...
		 * 상수(Constant)
		 *  - 값이 변하지 않는 변수
		 *  - 저장하고 있는 값에 대해서 가독성과 전달력을 높이기 위해 사용한다.
		 *  - public static final키워드를 사용하여 static영역에 데이터를 저장하고 재사용한다.
		 *  - 일반적으로 상수값은 변수명을 통해 의미를 부여하고, 실제 값은 정서값을 저장하는 경우가 많다
		 *    ex) Calendar.YEAR = 1;, 파이
		 *  
		 * */
		Car car1 = new Car();
		 ...
		 * EX) 다양한 어플리케이션에서 사용되는 상수값ㄷ이 있을때, 이를 하나의 변수로 관리하고 싶은 경우
