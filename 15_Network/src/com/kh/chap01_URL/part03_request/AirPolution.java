...
public class AirPolution {
	public static void main(String[] args) {
		 ...
		 *      데이터나 서비스를 제공하는 역활을 API서버라고 부른다(카카오 API서버, 네이버 API서버 등)
		 *    - A에플리케이션이 B에플리키이션에 필요한 데이터가 있는 경우, B에플리케이션의 API서버를 통해
		 ...
		 *     - EX) https://khedu.co.kr/data (쿼리스트링은 url에 노출되지 않는다.(로그인 할때 안보기게 하는거))
		 *  
		 ...
		 *  
		 * */
		//현제 여기서는 모록에서 시도별 실시가 측정정보 조회를 본는거임
		...
		//serviceUrl 에는 요청주소를 넣어야함(서비스URL아님)
