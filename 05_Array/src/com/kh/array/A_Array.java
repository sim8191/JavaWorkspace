...
public class A_Array {
	 ...
	 * 		int a = 10;
	 * 		a = 20;
	 * 배열 : 하나의 공간에 어러개의 값을 담을 수 있다.("같은 자료형"기준)
	 * 		ex) int[] a = new int[3];
	...
	public void method1() {
		...
		arr = new int[5];//할당 완료.
		int [] arr3 = new int[5]; // [0,0,0,0,0] 각자료형의 기본값으로 초기화되어 있음
	...
	public void method2() {
		...
		int[] iArr3 = iArr2;
		System.out.println("iArr2의 HashCode : " + iArr3.hashCode());
		
		//아래 의 비교는 주소값을 비교하고 있는 거임
...
//		}
	...
	public void method4() {
		int result = 0;
		String str = null;//문자열 초기화 null 혹은 ""
		int[] arr = null;//
...
//		System.out.print(arr[5]+" ");
		...
		// 배열의 범위를 넘어선 값들은 저장하고자 한다면, 새로운 배열을 생성해야한다.
	...
	public void method6() {
		...
		// 2.
		int[]arr2 = {1,2,3,4};//new int[]가 생량된거임
	}
	...
	public void method7() {
		...
		//Arrays.toString(배열) => 배열내부의 값등릉 문자열로 반환하여 반환하는 메서드.
