...
public class ArrayForeach {//향상된 반복문
...
//		향상된/개선된 반복문 advanced loop / foreach
		/*
		 * for each문
		 *  - 배열 또는 컬랙션과 함께 사용되는 반복문으로, 배열 또는 컬랙션의
		 *  0번 인덱스부너, 마지막 인덱스까지 순차적으로 접근할 때 사용.
		 *  
		 *  초기식 조건식 증감식 X
		 *  반복횟수는 배열의 크기.
		 *  [표현법]
		...
		phones[2] = new Phone("갤럭시","삼성","갤럭시25fe",900000);
		...
		System.out.println("총 가경의 합"+sum);
