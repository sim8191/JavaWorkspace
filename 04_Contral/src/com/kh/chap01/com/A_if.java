...
public class A_if {
	/*
	 * 조건문
	 *  - 족건식을 통해 참/거짓을 판단하여 그에 해당하는코드를 실행
	 *  - 조건식는 보통 비교연산자, 논리연산자를 사용하여 작성한다.
...
//		if (num<=13) System.out.println("어린이");
//		else if(num <= 19) System.out.println("청소년");
//		else if(num <= 60) System.out.println("성인");
//		else System.out.println("어르신");
	}
	
	public void method5() {
		//성별과 이름을 입력받아, 이름과 성별을 출력
		//성별은 m/f로 입력 받고 출력시에는 남자, 여자로 출력
...
//		}
		/*
		 * 기본자료형 : boolean, char, byte, short, int, long, double, float
		 * 참조자료형 : String
		 * 
		 * - 기본자료형간 비교시 ==, !=는 사용가능함.
		 * - 단, 참조자료형은 동등비교시 정상적인 비교가 안된다.
		 * - 참조자료형은 서러 값이 동일한지 비교할 때 .equals() 를 사용.
		 * */
		// 내부에 이름만 비교를 하기 위해서는 equals문을 사용해서 비교를 해야함
		if(name.equals("민경민")) {
			System.out.println(name + "님 반갑습니다.");
		}else {
			System.out.println("누구?");
