...
public class B_InDecrease {
	/*
	 * 증감연산자(단항연산자) ++ -- ++ : 변수에 담기 값을 1 증가 ++변수(전위연산자) 변수++(후위연산자)
	 * 
	 * -- : 변수에 담기 값을 1 감소(위아 전위 후위 가 있음)
	 * 
	...
	public void method4(){
        ...
        System.out.println(a++); // 10 출력후a = 11
        System.out.println((++a) + (b++)); // 32 출력후a = 12, b = 21
        System.out.println((a++)+(--b)+(--c)); // 61 출력후a = 13, b = 20, c = 29
