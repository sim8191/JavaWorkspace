...
public class Run {
	public static void main(String[] args) {
		 ...
		 *  - Round Robin은 os가 정하는 스레드 스케쥴링방식으로, 소스코드로 제어가 불가능한다.
		 *  
		 * 우선순위 기반 스케쥴링
		 *  - 스레드마다 우선순위를 부여하는 방식
...
//		t3.start();
		...
		t1.setPriority(Thread.MAX_PRIORITY); // 가장빨리 끝나야함
		t3.setPriority(Thread.MIN_PRIORITY); // 가장늦게 끝나야함
		
//		t1.start();
//		t2.start();
//		t3.start();
		
		/*데몬 = 백그라운드, 데몬스레드 = 백그라운드 스레드
		 * 데몬스레드
