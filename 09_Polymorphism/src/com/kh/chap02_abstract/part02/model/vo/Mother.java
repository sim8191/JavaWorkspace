...
// 인터페이슴 상속(implements) 12시
//  - 클래스와 클랫의 상속 관계(단일상속) : 클래스명 extends 무모클래스
//  - 클래스와 인터페이스의 상속 관계(다중상속) : 클래스명 implements 인터페이스 1, 인터페이스2, 3
//  - 인터페이스와 인터페이스의 상속 관계(다중상속) : 클래스명 extends 인터페이스 1, 인터페이스2, 3
...
public class Mother extends Person implements Basic{
	...
	@Override
	public String toString() {//알트 쉬프트 s 에 toString
