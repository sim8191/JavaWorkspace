...
public class Run {
	public static void main(String[] args) throws ClassNotFoundException, InstantiationException, IllegalAccessException {
		 ...
		 *  - Class클래스는 이 class자체의 정보를 가져올때 사용된다.
		 * */
		Run r = new Run();
		r.test1();
	...
	public void test1() throws ClassNotFoundException, InstantiationException, IllegalAccessException {
		...
		Class cl = b.getClass(); // Book클래스의 설계정보(.class파일 참조)
		...
		// new키워드 없이 객체 생성하기.
		Book b1 = (Book)c3.newInstance();//이런식으로 사용할수가 있다라고만 알아두기
		...
		// 필드정보 가져오기(Book 클래스의 필드가 private 인지 확인히기)
		 ...
		 * 메타데이터를 수집하기위해 사용한다.
		 * 
		 * 이를 통해 프래임워크에서는 어노테이션을 이용한 자동화구조를 설계하였다.
		 * */
	}
}
