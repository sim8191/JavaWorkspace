...
public class Run {
	public static void main(String[] args) {
		 ...
		 *  int              Integer
		 *  ....
		 *  int, char을 제외하고 나머지믄 이름이 같음(첫글자만 대문자인지만 확인)
		 *  <----->의 의미 양쪽으로 자동 형변환이됨
		 * 
		 * */
		int num1 = 10;
...
//		System.out.println(num1.equals(num2));
		...
		System.out.println(i1.compareTo(i2));//compareTo : 대소비교
		// a.compareTo(b)
		// a가 b보다 작은 경우 -1
		// a와 b가 같은경우 0
		// a가 b보다 큰 경우 1
		
		// Wrapper -> 기본자료형(UnBoxint)
		int num3 = i1;
		int num4 = i2;
		...
		// 기본자료형 --> String
		// 10 --> "10"
		String stri2 = i + "";//이걸사용하지 못하는 경우 아래를 사용하면됨
