...
public class B_StringBuilderAndBuffer {
	 ...
	 *  - StringBuffer는 동기화를 지원하기 때문에 '멀티스레드환경'에서 스레드 안정성을 보장할 수 있으나
	 *    성능이 좋지 못하다.
	 * */
	public void method() {
		String str = "Hello";
		...
		StringBuilder sb1 = new StringBuilder("hello"); //일반적인 선택지
		...
		// 0번인덱스부터 문자를 삭제.
//		System.out.println("모든 글자 삭제" + sb1.delete(0, 1));
//		System.out.println("모든 글자 삭제" + sb1.delete(0, sb1.length()-4));
